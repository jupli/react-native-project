...
const Icon: React.FC<IconProps> = ({ name, className = "w-6 h-6" }) => {
  ...
  const icons: { [key: string]: React.ReactElement } = {
    ...
    calories: <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M17.657 18.657A8 8 0 016.343 7.343S7 9 9 10c0-2 .5-5 2.986-7.014A8.003 8.003 0 0112 2c2.21 0 4.21.896 5.657 2.343A8 8 0 0117.657 18.657z" />,
    carbs: <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M13 10V3L4 14h7v7l9-11h-7z" />,
    protein: <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M13.828 10.172a4 4 0 00-5.656 0l-4 4a4 4 0 105.656 5.656l1.102-1.101m-.758-4.899a4 4 0 005.656 0l4-4a4 4 0 00-5.656-5.656l-1.1 1.1" />,
    fats: <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 15a4.001 4.001 0 001.031-7.855 4.001 4.001 0 00-2.062 0A4.001 4.001 0 0012 15z" /><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M19.07 4.93a10 10 0 00-14.14 0" /><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M15.536 8.464a5 5 0 00-7.072 0" />,
